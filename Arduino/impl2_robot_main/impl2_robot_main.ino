...
SoftwareSerial serial_SW_wireless_module(6, 7); // (RX, TX)

int gyro_address = 0x68;          //MPU-6050 I2C address (0x68 or 0x69)
int acc_calibration_value = 600;  //Enter the accelerometer calibration value (1000 in initial code)
...
// speed increase or decrease of the stepper motors when robot is turning;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
byte start=0, received_byte=0, low_bat=0;

int left_motor=0, throttle_left_motor=0, throttle_counter_left_motor=0, throttle_left_motor_memory=0;
int right_motor=0, throttle_right_motor=0, throttle_counter_right_motor=0, throttle_right_motor_memory=0;
int battery_voltage=0;
int receive_counter=0;
int gyro_pitch_data_raw=0, gyro_yaw_data_raw=0, accelerometer_data_raw=0;

long gyro_yaw_calibration_value=0, gyro_pitch_calibration_value=0;

unsigned long loop_timer=0;

float angle_gyro=0, angle_acc=0, angle=0, self_balance_pid_setpoint=0;
float pid_error_temp=0, pid_i_mem=0, pid_setpoint=0, gyro_input, pid_output=0, pid_last_d_error=0;
float pid_output_left=0, pid_output_right=0;
...
void setup()
{
  serial_SW_wireless_module.begin(9600);                                    // start SW serial that connects wireless modeul to Arduino;
  Serial.begin(9600);                                                       //Start the serial port at 9600 kbps
  Wire.begin();                                                             //Start the I2C bus as master
  // see page 215 of the atmega mcu manual;
  TWBR = 12;                                                                //Set the I2C clock speed to 400kHz

  //To create a variable pulse for controlling the stepper motors a timer is created that will execute a piece of code (subroutine) every 20us
  //This subroutine is called TIMER2_COMPA_vect
  // see chapter 18 of the atmega datasheet;
  ...
  // () calibrate the gyro; need output zero when the gyro is resting;
...
void loop()
{
  ...
  if(start == 0 && angle_acc > -0.5&& angle_acc < 0.5){                     //If the accelerometer angle is almost 0
    ...
    start = 1;                                                              //Set the start variable to start the PID controller; robot is active!
  }
  ...
  angle_gyro += gyro_pitch_data_raw * 0.000031;                             //Calculate the traveled angle in the previous 4ms during this loop 
  ...
  //The (pid_setpoint - pid_output * 0.015) part functions as a (parashute) brake function.
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // To compensate for the non-linear behaviour of the stepper motors' speed vs. the pulse time,
  // the folowing calculations are needed to get a linear speed behaviour.
...
{
  // this is called every 20 us by means of T/C 2 timer interrupt;
